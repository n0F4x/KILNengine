...
TEST_CASE("util::OptionalRef")
{
    ...
    {
        {
            constexpr kiln::util::OptionalRef<int> optional_ref{};
            [[maybe_unused]]
        ...
        SECTION("with value")
        {
            ...
            constexpr kiln::util::OptionalRef optional_ref{ value };
            constexpr static float            other_value{ 3.2f };
            constexpr auto optional{ optional_ref.transform([](const int&) -> float {
                return other_value;
            }) };
    ...
    {
        {
            constexpr kiln::util::OptionalRef<int> optional{};
            [[maybe_unused]]
            auto expected{ optional.or_else([] -> std::expected<int, float> {
                return {};
            }) };
        ...
        {
            constexpr static int              value{ 2 };
            constexpr kiln::util::OptionalRef optional{ value };
