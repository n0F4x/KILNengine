...
private:
    ...
    const Operations<size_T, alignment_T>* m_operations;
...
constexpr BasicAny<properties_T, ConceptPolicy_T, size_T, alignment_T>::BasicAny(
    ...
    requires(storable<T>())
    : m_operations{ &Traits<T, properties_T, size_T, alignment_T>::s_operations }
{
    Traits<T, properties_T, size_T, alignment_T>::create(
