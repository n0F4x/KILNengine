...
module kiln.reg.RegistryBuilder;
...
RegistryBuilder::RegistryBuilder(RegistryBuilder&& other, const allocator_type& allocator)
...
RegistryBuilder::RegistryBuilder(const allocator_type& allocator)
