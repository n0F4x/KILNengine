...
export module kiln.util.Strong;
...
public:
    ...
    constexpr auto underlying(this Self_T&&) noexcept -> forward_like_t<T, Self_T>;
...
template <typename... Args_T>
constexpr kiln::util::Strong<T, Tag_T>::Strong(
    std::in_place_t,
    Args_T&&... args
...
template <typename T, typename Tag_T>
template <typename Self_T>
constexpr auto kiln::util::Strong<T, Tag_T>::underlying(this Self_T&& self) noexcept
